...
- (void)drawView{
    ...
    self.toolView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width, SizeHeight(87/2))];
...
//    [self.toolView addSubview:aboveLineView];
    ...
    cancelButton.frame = CGRectMake(10, _toolView.frame.size.height/2-14, 40, 28);
    [cancelButton setTitle:@"取消" forState:UIControlStateNormal];
    [cancelButton setTitleColor:RGBColor(0,122,255) forState:UIControlStateNormal];
    [cancelButton addTarget:self action:@selector(cancelAction) forControlEvents:UIControlEventTouchUpInside];
    [self.toolView addSubview:cancelButton];
    
    
    UIButton *sureButton = [UIButton buttonWithType:UIButtonTypeCustom];
    sureButton.frame = CGRectMake(self.bounds.size.width - 50, _toolView.frame.size.height/2-14, 40, 28);
    [sureButton setTitle:@"确认" forState:UIControlStateNormal];
    [sureButton setTitleColor:RGBColor(0,122,255) forState:UIControlStateNormal];
