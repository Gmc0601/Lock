...
-(UIColor *)sliderColor
{
    if(_sliderColor == nil)
    {
        _sliderColor = UIColorFromHex(0x648DDD);
    }
    return  _sliderColor;
}
...
-(UIColor *)btnTextSeletedColor
{
    ...
    {
        _btnTextSeletedColor = UIColorFromHex(0x648DDD);
    }
...
-(void)addSliderView
{
    ...
    UIView *slider = [[UIView alloc]initWithFrame:CGRectMake(0,41,self.btnW, 2)];
    slider.backgroundColor = UIColorFromHex(0x648DDD);
...
-(void)addTopBar
{
    ...
    for (int i=0; i<count; i++)
    {
        ...
        UIView  *line = [[UIView alloc]initWithFrame:CGRectMake(self.btnW+(i * self.btnW+5), 15 + 64, 1, 12)];
        line.backgroundColor =UIColorFromHex(0x648DDD);
