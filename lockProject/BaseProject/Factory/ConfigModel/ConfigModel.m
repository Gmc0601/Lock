...
+ (void)jumptolockHistory:(UIViewController *)vc {
    LockhistoryViewController *new = [[LockhistoryViewController alloc] init];
    [vc.navigationController pushViewController:new animated:YES];
}
...
+ (BOOL)haveLogin:(UIViewController *)vc {
    if (![ConfigModel getBoolObjectforKey:IsLogin]) {
        ...
        na.navigationController.navigationBar.hidden = YES;
